...
const navItems = [
  ...
  { path: '/services', labelKey: 'sidebar.itemTypes', icon: Shirt, hideForSuperOwner: true, adminOnly: true },
  { path: '/cleaning-services', labelKey: 'sidebar.cleaningServices', icon: Sparkles, hideForSuperOwner: true, adminOnly: true },
