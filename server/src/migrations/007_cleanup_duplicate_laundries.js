...
async function up() {
  console.log('🔄 Running migration: 007_cleanup_duplicate_laundries');
  try {
    ...
    console.log('✅ Migration 007_cleanup_duplicate_laundries completed successfully!');
  } catch (error) {
    console.error('❌ Migration 007_cleanup_duplicate_laundries failed:', error);
    throw error;
  }
}

async function down() {
  console.log('🔄 Rolling back migration: 007_cleanup_duplicate_laundries');
  // Reversal is not applicable/necessary here as it's a cleanup task.
}
